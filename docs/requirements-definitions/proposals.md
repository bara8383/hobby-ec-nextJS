...
|---|---|---|---|---|---|---|---|
| P-001 | 提案 | Next.js の最小対応バージョン（例: v16系）を要件化 | App Router / Server Actions / Metadata の挙動差を減らすため、バージョン固定が必要 | `package.json` で major/minor 方針を定義し、要件に「検証対象バージョン」を追記 | 実装/CI/ドキュメント | 高 | 未決 |
